...
# TODO I did not complete this assignment.
...
def play_game():
    ...
    # Hint 11: The score will need to be rechecked with every new
    # card drawn and the checks in Hint 9 need to be repeated until the game ends.
    ...
    while not is_game_over:
        ...
        if user_score == 0 or computer_score == 0 or user_score > 21:
            ...
            # If yes, then use the deal_card() function to add another
