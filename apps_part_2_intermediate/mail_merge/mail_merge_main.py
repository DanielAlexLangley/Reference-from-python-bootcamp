...
# TO DO: Create a letter using main_merge_starting_letter.txt
...
with open("mail_merge_input/mail_merge_letters/main_merge_starting_letter.txt") as letter_file:
    ...
    for name in names:
        ...
        with open(f"./mail_merge_output/mail_merge_readytosend/letter_to_{stripped_name}.txt", mode="w") as completed_letter:
