...
def check_answer(guess, a_followers, b_followers):
    ...
    if a_followers > b_followers:  # clever return true or false if statement here.
        return guess == "a"  # clever return true or false if statement here.
    else:  # clever return true or false if statement here.
        return guess == "b"  # clever return true or false if statement here.
...
there for the rest of the game. This would be quite boring.
